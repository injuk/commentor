...
internal fun ListCommentsResponse.convert() = this.run {
...
private fun List<Comment>.convertToListOfComments() = this.map {
    ga.injuk.commentor.models.Comment(
        id = it.encodedId ?: throw UncaughtException("Failed to convert encode id"),
...
private fun CommentPart.convertToGeneratedCommentPart() = ga.injuk.commentor.models.CommentPart(
...
private fun CommentPartType.convertToGeneratedCommentPartType() = when (this) {
...
private fun Content.convertToGeneratedContent() = ga.injuk.commentor.models.Content(
...
private fun ContentType.convertToGeneratedContentType() = when (this) {
...
private fun MarkType?.convertToGeneratedMarkType() = when (this) {
...
private fun MarkAttrsType?.convertToGeneratedMarkAttrsType() = when (this) {
